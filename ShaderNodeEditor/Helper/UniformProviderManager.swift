...
class AudioUniformProviderManager: NSObject
{
    ...
    func initAudio() -> Void
    {
        do
        {
            ...
            try AVAudioSession.sharedInstance().setCategory(.playAndRecord, mode: .measurement, options: [.allowAirPlay,.allowBluetooth,.allowBluetoothA2DP,.defaultToSpeaker])
